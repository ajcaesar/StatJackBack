...
var Filter = /*#__PURE__*/function () {
  ...
  function Filter(config) {
    var words = dictionary.english;

    if (config) {
      var languagesChecks = new Set(config == null ? void 0 : config.languages);

      if (languagesChecks.size !== 0) {
        languagesChecks.forEach(function (lang) {
          words = [].concat(words, dictionary[lang]);
        });
      }
    }
  ...
  _proto.isProfane = function isProfane(value) {
    for (var _iterator = _createForOfIteratorHelperLoose(this.words), _step; !(_step = _iterator()).done;) {
      var word = _step.value;
      var wordExp = new RegExp("" + word.replace(/(\W)/g, '\\$1'), 'gi');
...
//# sourceMappingURL=profanity-check.cjs.development.js.map
